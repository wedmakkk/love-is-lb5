...
void gen_mat2(int n, int rib, int** adjacency_matrix, int** matrixs)
{
    for (int i = 0; i < n; i++) {
        for (int j = 0; j < rib; j++) {
            matrixs[i][j] = 0;
...
void print_matrix(int n, int** adjacency_matrix, int** matrixs,int rib)
{
    printf("Matrix:\n");
    for (int i = 0; i < n; i++) {
        for (int j = 0; j < n; j++) {
...
//}
//printf("\nribs2: % i\n", counter);
int counter_matrix(int n, int** adjacency_matrix)
{
    int counter = 0;
    for (int i = 0;i < n;i++)
    {
...
int main() {
    ...
    int ribs = 0;
    ribs = counter_matrix(n, matrix);
    int** matrixs = (int**)malloc(n * sizeof(int*));
    for (int i = 0; i < n; i++)
    {
        matrixs[i] = (int*)malloc(ribs * sizeof(int));

    }
    printf("%i", ribs);
    gen_mat2(n, ribs, matrix, matrixs);
    print_matrix(n, matrix,matrixs,ribs);
